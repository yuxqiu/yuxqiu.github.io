...
title = "TIL-6"
date = 2023-01-07
taxonomies = { tags = ["til", "c", "cpp", "rust"] }
+++
...
![Slide showing a parallel word_count implementation in C++ using std::transform_reduce with the ex::par_unseq execution policy, from a Bryce Adelstein Lelbach talk](/img/blog/2023/01/til-6-par-word-count.png)
