...
![parallel pollard's rho](/img/blog/2025/02/parallel-pollard-rho.png)
...
![cache-abstraction](/img/blog/2025/02/cache-abstraction.png)
*Cache Abstraction*
...
![problem-of-geostationary-satellites](/img/blog/2025/02/problem-of-geostationary-satellites.png)
*If all GPS satellites are geostationary, we cannot differentiate the north and south atmosphere.*

![number-of-satellites](/img/blog/2025/02/number-of-satellites.png)
*The number of visible satellites from every point on Earth, with density.*

![decode-signal](/img/blog/2025/02/decode-signal.png)
