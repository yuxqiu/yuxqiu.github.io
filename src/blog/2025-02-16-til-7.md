...
date = 2025-02-16
taxonomies = { tags = ["til", "llm", "algorithm"] }
+++
...
![Infographic illustrating five RAG chunking strategies: fixed-size, semantic, recursive, document structure-based, and LLM-based chunking](/img/blog/2025/02/rag-chunking.png)
