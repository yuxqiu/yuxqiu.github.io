...
date = 2025-03-06
taxonomies = { tags = ["til", "rust", "cryptography", "llm"] }
+++
...
![Diagram of Let's Encrypt domain validation: Let's Encrypt asks the web server's admin software to put a token at a URL on example.com and sign a nonce, proving control of the domain](/img/blog/2025/03/domain-verification.png)
...
![Diagram of certificate issuance: the web server's admin software exchanges a certificate signing request signed by the domain's key pair with Let's Encrypt, which returns the issued certificate signed by its own key](/img/blog/2025/03/certificate-issuance.png)
