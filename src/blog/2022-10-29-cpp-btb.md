...
> Talk: [Back to Basics: The Abstract Machine - Bob Steagall - CppCon 2020](https://www.youtube.com/watch?v=ZAji7PkXaKY)
>
> Slides: [back_to_basics_the_abstract_machine__bob_steagall__cppcon_2020.pdf](https://github.com/CppCon/CppCon2020/blob/main/Presentations/back_to_basics_the_abstract_machine/back_to_basics_the_abstract_machine__bob_steagall__cppcon_2020.pdf)
...
>
> Sergey Zubkow, [www.quora.com](https://www.quora.com) (2015)
...
![Diagram of source code, compiler, abstract machine, machine code, and physical machine, with source code, compiler, and abstract machine highlighted to show the compiler emulating the program on the abstract machine](/img/blog/2022/10/1667136550250.png)

![Same diagram with compiler, machine code, and physical machine highlighted instead, showing the compiler mapping abstract machine operations into machine code that runs on the physical machine](/img/blog/2022/10/1667136556130.png)
...
![Slide listing key aspects of the C++ abstract machine: implementation, parametrized, non-deterministic, and undefined operations on the left; rules for observable behavior and ignorable side effects on the right](/img/blog/2022/10/1667136570480.png)
...
![Diagram of the C++ abstract machine's structure: several thread icons and two object icons inside a memory region](/img/blog/2022/10/1667136579085.png)
...
> Talk: [Back to Basics: The Structure of a Program - Bob Steagall - CppCon 2020](https://www.youtube.com/watch?v=3KoXeegncrs)
>
...
- If names are these types of things ..., then it may have linkage
- External Linkage: can be used by other translational unit
- Internal Linkage: can be used inside the entire translational unit
- No Linkage: can only be used within the scope it's declared


### ODR

- A given translational unit can contain at most one definition of any ...
